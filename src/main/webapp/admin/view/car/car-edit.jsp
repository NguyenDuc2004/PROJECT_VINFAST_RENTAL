...
<div class="container py-5">
    <form action="${pageContext.request.contextPath}/product" method="post">
        ...
        <div class="row g-5 mt-2">
            <div class="col-lg-6">
                <div class="image-showcase text-center h-100 d-flex flex-column justify-content-center">
                ...
                <div class="form-container h-100">
                    ...
                    <div class="mb-5">
                        ...
                        <div class="plate-card">
                            <span class="plate-number">30H - ${car.id}${car.id}8.88</span>
                        </div>
                    </div>
                    ...
                    <div class="d-flex align-items-center justify-content-center gap-4 pt-4 border-top">
                        ...
                        <a href="${pageContext.request.contextPath}/product" class="btn-cancel-outline">
                            HỦY
                        </a>
                    </div>
